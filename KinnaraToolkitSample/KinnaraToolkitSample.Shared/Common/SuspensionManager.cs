    ...
    public sealed class SuspensionManager
    {
        ...
        public static async Task SaveAsync()
        {
            try
            {
                ...
                StorageFile file = await _folder.CreateFileAsync(sessionStateFilename, CreationCollisionOption.ReplaceExisting);
        ...
        public static async Task RestoreAsync(String sessionBaseKey = null)
        {
            ...
            try
            {
                ...
                StorageFile file = await _folder.GetFileAsync(sessionStateFilename);
