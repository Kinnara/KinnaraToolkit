...
namespace KinnaraToolkitSample.Data
{
    ...
    public class LoremIpsum : IEnumerable<string>
    {
        ...
        public static string Paragraphs
        {
            ...
            {
                EnsureParagraphs();
                return string.Join(Environment.NewLine + Environment.NewLine, _paragraphs);
            }
        }
        ...
        private static void EnsureParagraphs()
        {
            if (_paragraphs == null)
            {
                ...
                for (int i = 0; i < 5; i++)
                {
                    _paragraphs.Add(GetParagraph(5));
                }
            }
        }
        ...
        private static void EnsureSentences()
        {
            if (_sentences == null)
            {
                ...
                using (StringReader reader = new StringReader(ResourceLoader.GetForCurrentView().GetString("LoremIpsum")))
                {
                    while (reader.Peek() != -1)
                    {
